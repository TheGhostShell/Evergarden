...
class EvergardenAuthenticationManagerTest extends IntegrationCmsApplicationTests {
  ...
  EvergardenAuthenticationManager manager;

  @BeforeEach
  void setup() {
      manager = new EvergardenAuthenticationManager(jwtHelper);
  }
  ...
  void authenticateFailedWithBadToken() {
    ...
    Authentication authentication =
        new UsernamePasswordAuthenticationToken("batou@mail.com", "XLqMAPeSDKERF");
  ...
  void authenticatedSuccessWithGoodToken() {
    ...
    Authentication authentication =
        new UsernamePasswordAuthenticationToken("batou@mail.com", token);
