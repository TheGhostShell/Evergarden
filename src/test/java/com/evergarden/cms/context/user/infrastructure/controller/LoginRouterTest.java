...
class LoginRouterTest {
    ...
    void create() {
        ...
        userToSave.setEmail("batou@mail.com");
            userToSave.setFirstname("Batou");
        userToSave.setLastname("Ranger");
        userToSave.setPseudo("Batou");
        userToSave.setActivated(true);
        userToSave.addRole(new Role("admin"));
        userToSave.setEncodedCredential(encoder.getEncodedCredential());
